class ChessBoard {
    ...
    movePiece (oldRow, oldColumn, newRow, newColumn, actuallyMove) {
        ...
        if (this.board[oldRow][oldColumn].move(newRow, newColumn, actuallyMove)) {
            if (actuallyMove) {
                if (this.board[newRow][newColumn] != null) {
    ...
    checkIfInCheck (color) {
        ...
        for (var i = 0; i < 8; i++) {
            for (var j = 0; j < 8; j++) {
                if (this.containsPiece(i, j) && this.board[i][j].getType() == "king" && this.board[i][j].getColor() == color) {
                    kingRow = i;
                    kingColumn = j;
                }
            }
        ...
        for (var i = 0; i < 8; i++) {
            for (var j = 0; j < 8; j++) {
                if (this.containsPiece(i, j) && this.board[i][j].getColor() != color
