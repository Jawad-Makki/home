function calculate(){
    ...
    var del_volume = parseFloat(document.getElementById("del_volume").value);
    ...
    pressureAtm = yInt / area;

    del_pressureAtm = Math.sqrt(Math.pow(del_yInt / area, 2) + Math.pow(yInt * del_area / Math.pow(area, 2), 2));
    ...
    document.getElementById("pressure_atm").innerText = pressureAtm.toFixed(5) + " Pa";
    document.getElementById("del_pressure_atm").innerText = del_pressureAtm.toFixed(5) + " Pa";
}